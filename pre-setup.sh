...
S3_OBJECT_KEY="$S3_FOLDER/build.tar.gz"

# Upload the build.tar.gz file to S3
aws s3 cp ./build.tar.gz "s3://$S3_BUCKET/$S3_OBJECT_KEY" --profile AccountLevelFullAccess-503226040441
